...
const styles = StyleSheet.create({
  ...
  dateRange: { fontSize: 14, marginTop: 4 },
  infoRow: {
    flexDirection: "row", alignItems: "center", gap: 8,
    marginHorizontal: 20, marginBottom: 16, padding: 12, borderRadius: 10, borderWidth: 1,
  },
  infoText: { fontSize: 14 },
  runCard: { marginHorizontal: 20, marginBottom: 14, borderRadius: 14, borderWidth: 1, padding: 16 },
  runHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 8 },
  runIndex: { fontSize: 12, fontWeight: "500" },
  typeTag: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 20 },
  typeTagText: { fontSize: 12, fontWeight: "600" },
  runName: { fontSize: 16, fontWeight: "600", marginBottom: 12 },
  segmentsList: { gap: 8 },
  segmentItem: { flexDirection: "row", gap: 10, alignItems: "flex-start" },
  segmentBullet: { width: 20, height: 20, borderRadius: 10, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  segmentBulletText: { color: "#fff", fontSize: 11, fontWeight: "700" },
  segmentText: { fontSize: 14, flex: 1, lineHeight: 20 },
  notesCard: { marginHorizontal: 20, marginTop: 4, marginBottom: 8, borderRadius: 12, borderWidth: 1, padding: 14, flexDirection: "row", gap: 10 },
  notesText: { fontSize: 14, flex: 1, lineHeight: 20 },
});
