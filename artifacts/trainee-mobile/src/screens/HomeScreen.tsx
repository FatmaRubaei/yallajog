  ...
  return (
    ...
    >
      ...
      <View style={styles.statsRow}>
        <StatCard label="Runs/Week" value={String(trainee?.runsPerWeek ?? 0)} />
        <StatCard
          label="Target HR"
...
const styles = StyleSheet.create({
  ...
  runCard: { marginHorizontal: 20, marginBottom: 12, borderRadius: 12, borderWidth: 1, padding: 16 },
  runHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 6 },
  runBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 20 },
  runBadgeText: { fontSize: 12, fontWeight: "600" },
  runType: { fontSize: 12, fontWeight: "600" },
  runName: { fontSize: 15, fontWeight: "600", marginBottom: 10 },
  segmentRow: { flexDirection: "row", gap: 8, paddingLeft: 8, borderLeftWidth: 2, marginBottom: 6 },
  segmentNum: { fontSize: 13, fontWeight: "500" },
  segmentText: { fontSize: 13, flex: 1, lineHeight: 18 },
  announcementCard: { marginHorizontal: 20, marginBottom: 10, borderRadius: 12, borderWidth: 1, padding: 14 },
  annTitle: { fontSize: 14, fontWeight: "600", marginBottom: 4 },
  annContent: { fontSize: 13, lineHeight: 18 },
  setupCard: { margin: 20, alignItems: "center", gap: 12, paddingTop: 60 },
  setupIconBg: { width: 80, height: 80, borderRadius: 40, alignItems: "center", justifyContent: "center", marginBottom: 8 },
  setupTitle: { fontSize: 22, fontWeight: "700", textAlign: "center" },
  setupSubtitle: { fontSize: 15, textAlign: "center", lineHeight: 22 },
  setupButton: { marginTop: 8, paddingHorizontal: 32, paddingVertical: 14, borderRadius: 12 },
