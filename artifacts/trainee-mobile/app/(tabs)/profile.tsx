...
export default function ProfileScreen() {
  ...
  function handleLogout() {
    Alert.alert("Sign out", "Remove your trainee profile from this device?", [
      ...
      {!traineeId ? (
              ...
              <View style={styles.listContainer}>
                {allTrainees.map((t) => (
                  ...
                  >
                    ...
                    <Text style={[styles.traineeCity, { color: colors.mutedForeground }]}>{t.city} · ID: {t.id}</Text>
                  </TouchableOpacity>
                ))}
              </View>
            )}
        ...
        <>
          <View style={styles.avatarSection}>
            ...
            {trainee.city && (
              <Text style={[styles.profileCity, { color: colors.mutedForeground }]}>
                <Feather name="map-pin" size={13} /> {trainee.city}
              </Text>
            )}
            <View style={[styles.planBadge, { backgroundColor: trainee.planType === "paid" ? colors.primary + "22" : colors.muted }]}>
              <Text style={[styles.planText, { color: trainee.planType === "paid" ? colors.primary : colors.mutedForeground }]}>
...
const styles = StyleSheet.create({
  ...
  loginTitle: { fontSize: 20, fontFamily: "Inter_700Bold" },
  loginSubtitle: { fontSize: 14, fontFamily: "Inter_400Regular", textAlign: "center", lineHeight: 20 },
  input: {
    width: "100%",
    height: 48,
    borderRadius: 10,
  ...
  selectButtonText: { fontSize: 14, fontFamily: "Inter_500Medium" },
  listContainer: { width: "100%", marginTop: 4 },
  traineeItem: { paddingVertical: 12, borderBottomWidth: 1, width: "100%" },
  traineeName: { fontSize: 15, fontFamily: "Inter_500Medium" },
  traineeCity: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 2 },
  ...
  profileCity: { fontSize: 14, fontFamily: "Inter_400Regular", marginTop: 4 },
